...
export const MedalFillIcon = ({ className = '', width = '20', height = '20' }) => {
    return (
        <div className={`icon-style ${className}`}>
            <Icon width={width} height={height}>
                <path
...
export const GifrLineIcon = ({ className = '', width = '20', height = '20' }) => {
    return (
        <div className={`icon-style ${className}`}>
            <Icon width={width} height={height}>
                <path
...
export const StarHalf = ({ className = '', width = '20', height = '20' }) => {
    return (
        <div className={`icon-style ${className}`}>
            <Icon width={width} height={height}>
                <path
...
export const EqualLineIcon = ({ className = '', width = '20', height = '20' }) => {
    return (
        <div className={`icon-style ${className}`}>
            <Icon width={width} height={height}>
                <path d="M19 8H5V10H19V8ZM19 14H5V16H19V14Z" fill="currentColor"></path>
            </Icon>
        </div>
    );
};
